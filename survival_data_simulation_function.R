...
# Similar to cross-sectional data with binary outcome, it 
# must be a fucntion which takes n as its first argument 
# and a tuning parameter as its second argument - this is beta_signal in the example
...
generate_survival_data <- function(n, beta_signal) {
  ...
  event_time = 0.001 + pmin(round(generated_times/final_time*observe_time, 3),
                            observe_time) 
  ...
  } else {censored_time = observe_time}
