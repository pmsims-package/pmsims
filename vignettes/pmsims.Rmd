...
use_cache <- TRUE
vignette_cache_dir <- normalizePath(
...
if (use_cache) {
  ...
  saveRDS(binary_example, file = file.path(vignette_cache_dir, "binary.rds"))
}
...
if (use_cache) {
  ...
  saveRDS(continuous_example, file = file.path(vignette_cache_dir, "continuous.rds"))
}
