...
<!-- badges: start -->
[![CRAN status](https://www.r-pkg.org/badges/version/pmsims)](https://CRAN.R-project.org/package=pmsims)
...
how models are fitted, and how predictive performance is measured. Built-in
workflows cover continuous, binary, and time-to-event outcomes, with a choice of
regression-based models (linear, logistic, and Cox) and machine-learning models
...
and patient partners. See the [pmsims project site](https://pmsims.com/) for
further details.

## Installation

Install the stable `1.0.0` release from [CRAN](https://CRAN.R-project.org/package=pmsims):
